...
gst-launch-1.0 zedsrc resolution=1 framerate=30 ! queue ! timeoverlay ! identity drop-allocation=true ! tee name=split ! \
 ...
 rtph264pay config-interval=-1 pt=96 ! queue ! udpsink clients=192.168.0.50:5000,192.168.0.51:5000,192.168.0.52:5000 max-bitrate=3000000 sync=false async=false
